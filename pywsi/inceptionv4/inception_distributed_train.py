...
from pywsi.inceptionv4 import image_processing
...
tf.app.flags.DEFINE_string(
    'ps_hosts', '', """Comma-separated list of hostname:port for the """
    """parameter server jobs. e.g. """
    """'machine1:2222,machine2:1111,machine2:2222'""")
tf.app.flags.DEFINE_string(
    'worker_hosts', '', """Comma-separated list of hostname:port for the """
    """worker jobs. e.g. """
    """'machine1:2222,machine2:1111,machine2:2222'""")
tf.app.flags.DEFINE_string(
    'protocol', 'grpc', """Communication protocol to use in distributed """
    ...
    with tf.device('/job:worker/task:%d' % FLAGS.task_id):
        ...
        with slim.scopes.arg_scope(
            ...
            num_batches_per_epoch = (
                dataset.num_examples_per_epoch() / FLAGS.batch_size)
            ...
            while not sv.should_stop():
                try:
                    ...
                    if step % 30 == 0:
                        ...
                        tf.logging.info(
                            format_str % (FLAGS.task_id, datetime.now(), step,
