...
def atrous_conv_bn_relu(nb_filter,
                        nb_row,
                        nb_col,
                        atrous_rate=(2, 2),
                        subsample=(1, 1),
