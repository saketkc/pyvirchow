  ...
  """
    ...
    with tf.variable_scope(scope, 'InceptionResnetV2', [inputs]):
        with slim.arg_scope(
            ...
            # 147 x 147 x 32
            net = slim.conv2d(
                net, 32, 3, padding=padding, scope='Conv2d_2a_3x3')
            ...
            # 73 x 73 x 80
            net = slim.conv2d(
                net, 80, 1, padding=padding, scope='Conv2d_3b_1x1')
            if add_and_check_final('Conv2d_3b_1x1', net):
                return net, end_points
            # 71 x 71 x 192
            net = slim.conv2d(
                net, 192, 3, padding=padding, scope='Conv2d_4a_3x3')
            ...
            net = slim.repeat(
                net, 10, block35, scale=0.17, activation_fn=activation_fn)
            ...
            # TODO(alemi): register intermediate endpoints
            net = slim.repeat(
                net, 9, block8, scale=0.20, activation_fn=activation_fn)
