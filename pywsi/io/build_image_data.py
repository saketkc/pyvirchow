...
tf.app.flags.DEFINE_integer(
    "train_shards", 2, "Number of shards in training TFRecord files."
)
tf.app.flags.DEFINE_integer(
    "validation_shards", 2, "Number of shards in validation TFRecord files."
)
...
def _process_image_files_batch(
    coder, thread_index, ranges, name, filenames, texts, labels, num_shards
):
...
def main(unused_argv):
    ...
    _process_dataset(
        "train", FLAGS.train_directory, FLAGS.train_shards, FLAGS.labels_file
    )
