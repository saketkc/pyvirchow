...
# -*- coding: utf-8 -*-
#
# pywsi documentation build configuration file, created by
...
version = pywsi.__version__
# The full version, including alpha/beta/rc tags.
release = pywsi.__version__
...
latex_documents = [
    (master_doc, 'pywsi.tex',
     u'pywsi Documentation',
